...
from custom_agent.mvp_hierarchical.modules.perception_nt import PerceptionModule, PerceptionResult
...
from custom_agent.mvp_hierarchical.modules.planner_nt import Planner
...
from custom_agent.mvp_hierarchical.executors.general_executor_nt import GeneralExecutorNT
...
from custom_agent.mvp_hierarchical.executors.dialogue_executor_nt import DialogueExecutorNT
...
@AgentRegistry.register("mvp_nt")
class MVPNTAgent(BaseLangChainAgent):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.executors: Dict[str, BaseExecutor] = {
            ...
            'navigation': NavigationExecutorNT(action_batch_size=action_batch_size),
            'battle': BattleExecutor(),
            'general': GeneralExecutorNT(reasoner=self.reasoner),
            'dialogue': DialogueExecutorNT(
                backend=backend,
                model_name=model_name,
                temperature=temperature,
                **kwargs
        ...
        # Set navigation agent reference for dialogue executor
        self.executors['dialogue'].set_navigation_agent(self.executors['navigation'])
        ...
        # Track if we've reached LITTLEROOT TOWN (handover point)
    ...
    def step(self, game_state: dict) -> dict:
        ...
        # 2. Saliency detection (only after LITTLEROOT TOWN)
