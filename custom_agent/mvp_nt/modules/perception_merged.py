...
from custom_utils.map_extractor_nt import get_player_centered_grid
...
from custom_utils.object_detector_nt import ObjectDetectorNT
# NT: Import NT versions for enhanced navigation targets and map extraction
...
class PerceptionModule:
    ...
    def __init__(self, reasoner=None):
        ...
        self.object_detector = ObjectDetectorNT()
    ...
    def _generate_navigation_targets(
        ...
        # NT: Use NT version of generate_navigation_targets for enhanced target generation
        targets = generate_navigation_targets_NT(
            detected_objects=detected_objects,
