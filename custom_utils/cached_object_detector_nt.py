...
from custom_utils.object_detector_nt import ObjectDetector
from custom_utils.cache_utils import get_object_detector_cache

logger = logging.getLogger(__name__)


class CachedObjectDetector(ObjectDetector):
    """
    Cached wrapper for Azure Computer Vision API with per-feature caching.
    
    Supports independent caching of visual features (OBJECTS, DENSE_CAPTIONS, PEOPLE)
    ...
    def __init__(self, endpoint: Optional[str] = None, key: Optional[str] = None,
        ...
        """
        Initialize cached object detector with unified Store interface.
        ...
        logger.info(f"Initialized CachedObjectDetector with {type(self.cache).__name__}")
    ...
    def _generate_cache_key(self, image_hash: str, feature: str) -> str:
        ...
        Args:
            ...
            feature: Visual feature name (e.g., 'OBJECTS', 'DENSE_CAPTIONS', 'PEOPLE')
    ...
    def _get_analysis_result(self, scaled_frame: np.ndarray,
        ...
        """
        # Default to all features to match parent class behavior
